 ...
 */
public interface ApplicationInputPortFileMetadata {
     ...
     */
    SharedFileMetadataResponse retrieveMetadata(@NotBlank String fileID);
     ...
     * @throws ai.shreds.application.exceptions.ApplicationMetadataException if the file is not found
     */
    List<SharedVersionRecordResponse> retrieveVersionHistory(@NotBlank String fileID);
}
