...
@Value
@Builder
public class DomainOwnershipValue {
     ...
     * @return DomainOwnershipValue instance
     * @throws IllegalArgumentException if the JSON is invalid
     */
    public static DomainOwnershipValue fromJson(String json) {
        try {
            return objectMapper.readValue(json, DomainOwnershipValue.class);
        } catch (JsonProcessingException e) {
            ...
            try {
                ...
                DomainOwnershipValue ownership = DomainOwnershipValue.builder()
                        .owner(owner)
                        .groupId(groupId)
                        .build();
     ...
     */
    public boolean isSameGroup(DomainOwnershipValue other) {
        if (other == null) {
            return false;
        }
    ...
    /**
     * Checks if this ownership has write permissions.
     *
     * @return true if the owner or group has write permissions
     */
    public boolean hasWritePermissions() {
        return hasAdminRights() || !groupId.startsWith("readonly-");
    }

    /**
     * Creates a new ownership value object with read-only permissions.
     *
     * @param owner The owner name
     * @return DomainOwnershipValue with read-only permissions
     */
    public static DomainOwnershipValue createReadOnly(String owner) {
        return DomainOwnershipValue.builder()
                .owner(owner)
                .groupId("readonly-group")
                .build();
    }
}
